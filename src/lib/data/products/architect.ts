...
const courseDetail: CourseDetail = {
  slug: "architect",
  title: "건축가 체험: 미래 도시를 설계하라",
  subtitle: "건축 설계의 기초부터 모형 제작까지, 공간을 창조하는 전문가의 세계를 체험하는 프로그램",
  heroImageSrc: "/images/products/architect/hero.png",
  heroEyebrow: "DREAMPLEX · 건축/설계 진로직업체험",
  heroHeadline: "선 하나가 사람이 사는 공간이 된다",
  heroSubcopy: "현직 건축사가 학교로 찾아가, 건축 설계의 사고방식과 모형 제작 기법을 가르칩니다.",
  heroChips: ["초등 대상","건축 설계","모형 제작"],
  heroProofStats: [
    { label: "운영 학교", value: "34+" },
    { label: "참여 학생", value: "3,982+" },
    { label: "평균 만족도", value: "4.8 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "건축/설계", "초등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX ARCHITECT",
    role: "현직 건축사 & 도시 설계 전문가",
    avatarSrc: "",
    bio: "현직 건축사 & 도시 설계 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
