...
const courseDetail: CourseDetail = {
  slug: "music-producer",
  title: "음악 프로듀서 체험: 비트 메이킹의 세계",
  subtitle: "DAW 소프트웨어로 나만의 비트를 만들며 음악 산업의 핵심 직업을 탐색하는 프로그램",
  heroImageSrc: "/images/products/music-producer/hero.png",
  heroEyebrow: "DREAMPLEX · 미디어/방송 진로직업체험",
  heroHeadline: "한 번의 클릭이 수만 명의 심장을 울린다",
  heroSubcopy: "현직 음악 프로듀서가 학교로 찾아가, 디지털 음악 제작의 A to Z를 가르칩니다.",
  heroChips: ["중등 대상","비트 메이킹","DAW 실습"],
  heroProofStats: [
    { label: "운영 학교", value: "64+" },
    { label: "참여 학생", value: "3,722+" },
    { label: "평균 만족도", value: "4.8 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "미디어/방송", "중등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX PRODUCER",
    role: "현직 음악 프로듀서 & 사운드 디자이너",
    avatarSrc: "",
    bio: "현직 음악 프로듀서 & 사운드 디자이너이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
