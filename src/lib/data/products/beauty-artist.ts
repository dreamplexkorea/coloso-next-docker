...
const courseDetail: CourseDetail = {
  slug: "beauty-artist",
  title: "뷰티 아티스트 체험: 메이크업 & 스타일링의 과학",
  subtitle: "색채학과 피부과학을 기반으로 한 프로페셔널 뷰티 체험 프로그램",
  heroImageSrc: "/images/products/beauty-artist/hero.png",
  heroEyebrow: "DREAMPLEX · 뷰티/패션 진로직업체험",
  heroHeadline: "색의 조합이 자신감의 언어가 되는 순간",
  heroSubcopy: "현직 뷰티 아티스트가 학교로 찾아가, 과학 기반의 뷰티 교육을 제공합니다.",
  heroChips: ["중등 대상","색채학 기반","스타일링 실습"],
  heroProofStats: [
    { label: "운영 학교", value: "91+" },
    { label: "참여 학생", value: "7,663+" },
    { label: "평균 만족도", value: "4.9 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "뷰티/패션", "중등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX BEAUTY",
    role: "현직 뷰티 아티스트 & 색채학 전문가",
    avatarSrc: "",
    bio: "현직 뷰티 아티스트 & 색채학 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
