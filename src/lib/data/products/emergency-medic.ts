...
const courseDetail: CourseDetail = {
  ...
  title: "응급구조사 체험: 생명을 살리는 골든타임의 직업",
  subtitle: "심폐소생술(CPR)과 응급처치의 핵심을 체험하며 구조의 과학을 배우는 프로그램",
  heroImageSrc: "/images/products/emergency-medic/hero.png",
  heroEyebrow: "DREAMPLEX · 의료/건강 진로직업체험",
  heroHeadline: "4분의 골든타임, 당신의 손이 생명을 결정한다",
  heroSubcopy: "현직 응급구조사가 학교로 찾아가, 응급처치의 기본과 생명 존중의 가치를 가르칩니다.",
  heroChips: ["중등 대상","CPR 실습","응급처치"],
  heroProofStats: [
    { label: "운영 학교", value: "56+" },
    { label: "참여 학생", value: "7,643+" },
    { label: "평균 만족도", value: "4.8 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "의료/건강", "중등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX MEDIC",
    role: "현직 1급 응급구조사 & 건강교육 전문가",
    avatarSrc: "",
    bio: "현직 1급 응급구조사 & 건강교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
  ...
  curriculum: [
    {
      ...
      lessons: [
        { id: "l-1-1", title: "이론 탐구: 핵심 원리와 현장의 이야기", duration: "27분" },
        { id: "l-1-2", title: "관찰과 분석: 전문가처럼 생각하기", duration: "18분" },
      ],
    },
    {
      id: "ch-2",
      ...
      lessons: [
        { id: "l-2-1", title: "실습: 핵심 기술 직접 체험하기", duration: "23분" },
        { id: "l-2-2", title: "프로젝트: 나만의 결과물 완성 & 발표", duration: "23분" },
      ],
    },
  ],
  introSections: [
