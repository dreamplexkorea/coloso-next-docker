...
const courseDetail: CourseDetail = {
  ...
  title: "프로파일러 체험: 범죄심리를 분석하는 전문가",
  subtitle: "심리학과 행동 분석의 원리를 배우며 범죄 예방의 과학을 체험하는 프로그램",
  heroImageSrc: "/images/products/forensic-psychologist/hero.png",
  heroEyebrow: "DREAMPLEX · 심리/상담 진로직업체험",
  heroHeadline: "행동에는 이유가 있고, 심리에는 패턴이 있다",
  heroSubcopy: "범죄심리학 전문가가 학교로 찾아가, 프로파일링의 기초와 심리학적 사고를 가르칩니다.",
  heroChips: ["고등 대상","범죄심리학","프로파일링"],
  heroProofStats: [
    { label: "운영 학교", value: "81+" },
    { label: "참여 학생", value: "3,329+" },
    { label: "평균 만족도", value: "4.7 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "심리/상담", "고등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX PROFILER",
    role: "범죄심리학 석사 & 상담심리 전문가",
    avatarSrc: "",
    bio: "범죄심리학 석사 & 상담심리 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
