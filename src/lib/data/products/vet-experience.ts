...
const courseDetail: CourseDetail = {
  slug: "vet-experience",
  title: "수의사 체험: 동물의 생명을 지키는 과학의 힘",
  subtitle: "동물 해부학 기초부터 진찰 실습까지, 생명과학의 가치를 경험하는 진로체험 프로그램",
  heroImageSrc: "/images/products/vet-experience/hero.png",
  heroEyebrow: "DREAMPLEX · 의료/건강 진로직업체험",
  heroHeadline: "작은 심장 속의 큰 과학을 발견하라",
  heroSubcopy: "현직 수의사가 학교로 찾아가, 동물 건강과 생명과학의 기초를 가르칩니다.",
  heroChips: ["초등 대상","생명과학","동물 건강"],
  heroProofStats: [
    { label: "운영 학교", value: "117+" },
    { label: "참여 학생", value: "9,781+" },
    { label: "평균 만족도", value: "4.7 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "의료/건강", "초등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX VET",
    role: "현직 수의사 & 생명과학 교육 전문가",
    avatarSrc: "",
    bio: "현직 수의사 & 생명과학 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
