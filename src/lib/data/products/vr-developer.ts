...
const courseDetail: CourseDetail = {
  slug: "vr-developer",
  title: "VR 개발자 체험: 가상현실 세계를 만드는 기술",
  subtitle: "VR 헤드셋 체험부터 간단한 3D 환경 제작까지, 메타버스 시대의 핵심 기술을 탐색하는 프로그램",
  heroImageSrc: "/images/products/vr-developer/hero.png",
  heroEyebrow: "DREAMPLEX · IT/프로그래밍 진로직업체험",
  heroHeadline: "현실을 넘어, 새로운 세계를 코딩하라",
  heroSubcopy: "VR/AR 개발 전문가가 학교로 찾아가, 가상현실 기술의 원리와 가능성을 가르칩니다.",
  heroChips: ["중등 대상","VR 체험","3D 제작"],
  heroProofStats: [
    { label: "운영 학교", value: "95+" },
    { label: "참여 학생", value: "7,940+" },
  ...
  instructor: {
    name: "DREAMPLEX VR",
    role: "VR/AR 개발자 & 메타버스 교육 전문가",
    avatarSrc: "",
    bio: "VR/AR 개발자 & 메타버스 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
