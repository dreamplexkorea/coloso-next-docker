...
const courseDetail: CourseDetail = {
  slug: "startup-ceo",
  title: "스타트업 대표 체험: 사업계획서부터 피칭까지",
  subtitle: "아이디어 발굴, 비즈니스 모델 설계, 투자자 피칭까지 N잡 시대의 창업 역량을 키우는 프로그램",
  heroImageSrc: "/images/products/startup-ceo/hero.png",
  heroEyebrow: "DREAMPLEX · 경영/비즈니스 진로직업체험",
  heroHeadline: "세상의 불편함을 발견하라, 그것이 사업의 시작이다",
  heroSubcopy: "실제 스타트업 대표 출신 강사가 학교로 찾아가, 창업의 사고방식과 실전 역량을 가르칩니다.",
  heroChips: ["고등 대상","비즈니스 모델","피칭 실습"],
  heroProofStats: [
    { label: "운영 학교", value: "123+" },
    { label: "참여 학생", value: "8,923+" },
    { label: "평균 만족도", value: "4.7 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "경영/비즈니스", "고등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX CEO",
    role: "연쇄 창업가 & 스타트업 교육 전문가",
    avatarSrc: "",
    bio: "연쇄 창업가 & 스타트업 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
