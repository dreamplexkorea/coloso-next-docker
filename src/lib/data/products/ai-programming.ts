...
const courseDetail: CourseDetail = {
  slug: "ai-programming",
  title: "인공지능 프로그래머 체험: AI와 함께하는 코딩의 세계",
  subtitle: "Python과 AI 모델의 기초를 체험하며 미래 IT 산업의 핵심 직업을 탐색하는 프로그램",
  heroImageSrc: "/images/products/ai-programming/hero.png",
  heroEyebrow: "DREAMPLEX · IT/프로그래밍 진로직업체험",
  heroHeadline: "코드 한 줄이 세상을 바꾸는 순간을 경험하라",
  heroSubcopy: "현직 AI 엔지니어 출신 강사가 학교로 찾아가, 코딩의 논리적 사고와 AI의 가능성을 가르칩니다.",
  heroChips: ["중등 대상","블록코딩/AI 실습","STEM 융합"],
  heroProofStats: [
    { label: "운영 학교", value: "122+" },
    { label: "참여 학생", value: "6,883+" },
    { label: "평균 만족도", value: "4.8 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "IT/프로그래밍", "중등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX CODER",
    role: "현직 AI 엔지니어 & 코딩 교육 전문가",
    avatarSrc: "",
    bio: "현직 AI 엔지니어 & 코딩 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
  ...
  curriculum: [
    {
      ...
      lessons: [
        { id: "l-1-1", title: "이론 탐구: 핵심 원리와 현장의 이야기", duration: "30분" },
        { id: "l-1-2", title: "관찰과 분석: 전문가처럼 생각하기", duration: "20분" },
      ],
    },
    {
      id: "ch-2",
      ...
      lessons: [
        { id: "l-2-1", title: "실습: 핵심 기술 직접 체험하기", duration: "25분" },
        { id: "l-2-2", title: "프로젝트: 나만의 결과물 완성 & 발표", duration: "25분" },
      ],
    },
  ],
  introSections: [
