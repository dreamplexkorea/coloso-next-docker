...
const courseDetail: CourseDetail = {
    ...
    subtitle:
        "중·고등학생 대상 6차시 프로젝트형 AI 리터러시 프로그램. 직접 나만의 AI 멘토를 설계하고, 만들고, 발표합니다.",
        ...
        interview: [
            {
                ...
                answer:
                    "단순히 AI에게 질문하는 법을 가르치는 게 아닙니다. '나의 상황 × 거인의 사고방식 = 맞춤형 통찰'이라는 공식처럼, 학생들이 직접 위인의 사고 체계를 분석하고 이를 AI 에이전트로 구현합니다. 앵무새처럼 답변하는 챗봇이 아니라, 나만의 멘토를 만드는 경험이죠.",
            },
            {
                question: "코딩을 전혀 모르는 학생도 참여할 수 있나요?",
                answer:
                    "네, 100% 노코드 실습입니다. 블록을 조립하듯 AI 에이전트를 만들기 때문에 코딩 경험이 전혀 없어도 괜찮습니다. 오히려 기획력과 사고력이 더 중요한 프로그램입니다.",
            },
            {
                question: "6차시 후 학생들에게 어떤 변화가 생기나요?",
                answer:
                    "교육 전에는 'AI는 만능 도구'라고 생각하던 학생들이, 교육 후에는 AI를 내 의도와 목적에 맞게 설계하는 능동적 도구로 인식하게 됩니다. AI도 오류가 가능하다는 것을 직접 발견하고, 비판적으로 검증하는 시야을 갖추게 되죠.",
            },
            {
                question: "프로그램 후 학생들에게 남는 산출물은 무엇인가요?",
                answer:
                    "세 가지가 남습니다. 첫째, 언제든 접속해 대화할 수 있는 맞춤형 AI 에이전트 링크. 둘째, 거인 설계 캔버스 기획서와 엔지니어링 리포트. 셋째, AI의 한계를 알고 주도적으로 활용하는 비판적 사고 마인드셋입니다.",
            },
        ],
    },
    meta: {
    ...
    expectedOutcomes: [
        {
            title: "AI 도구 활용 능력",
            description: "ChatGPT, 노코드 에이전트 빌더 등 최신 AI 도구를 직접 활용",
            iconType: "scale",
        },
        {
            title: "프로젝트 기반 산출물",
            description: "실제 AI 에이전트를 만들어보고 포트폴리오로 활용 가능",
            iconType: "users",
        },
        {
            title: "미래 진로 탐색",
    ...
    introSections: [
        ...
        },
        {
            ...
            description:
                "학생이 만든 스티브 잡스 AI가 오히려 질문을 던집니다. 정해진 답변이 아닌, 깊이 있는 통찰을 이끌어내는 능동적 대화 경험을 선사합니다.",
            imageSrc: "",
        },
        {
            ...
            title: "위인들의 AI 토론 배틀",
            description:
                '간디 AI vs 마키아벨리 AI. 학생들이 직접 만든 에이전트들이 정반대의 관점으로 토론하며 "정답이 없는 문제"의 관점의 가치를 배웁니다.',
            imageSrc: "",
        },
        {
            ...
            title: "할루시네이션 직접 발견",
            description:
                "타 팀의 AI를 상호 테스트하며 오류와 거짓말을 직접 밝혀냅니다. 무비판적 수용의 위험을 체감하고 검증의 중요성을 스스로 깨닫습니다.",
            imageSrc: "",
        },
        {
            subtitle: "TRANSFORMATION",
            title: "단 6시간, 교육이 가져올 확실한 변화",
            description:
                "교육 전: 'AI는 만능 도구, 답변은 100% 사실' → 교육 후: AI를 내 의도와 목적에 맞게 설계하는 능동적 도구로 인식. 내가 필요한 AI를 구조적으로 기획하고 직접 구축하며, AI도 오류가 가능함을 알고 비판적으로 검증하는 시야을 장착합니다.",
            imageSrc: "",
        },
        {
            subtitle: "PORTFOLIO",
            ...
            description:
                "맞춤형 AI 에이전트 링크 — 언제 어디서든 접속해 대화 및 시연 가능. 기획 및 테스트 문서 — 거인 설계 캔버스 기획서와 엔지니어링 리포트 아카이브. AI 기술 활용 마인드셋 — AI의 한계를 알고 주도적으로 활용하는 비판적 사고방식. 생기부와 진로 포트폴리오에 즉시 활용할 수 있습니다.",
            imageSrc: "",
        },
    ],
    requiredTools: [
    ...
    notice: {
        ...
        learningPolicy: [
            "프로그램은 총 6차시(약 5시간)로 구성되며, 학교 시간표에 맞춰 운영됩니다.",
