...
const courseDetail: CourseDetail = {
    ...
    instructor: {
        ...
        interview: [
            ...
            },
            {
                ...
                answer:
                    "교육 전에는 'AI는 만능 도구'라고 생각하던 학생들이, 교육 후에는 AI를 내 의도와 목적에 맞게 설계하는 능동적 도구로 인식하게 됩니다. AI도 오류가 가능하다는 것을 직접 발견하고, 비판적으로 검증하는 시야를 갖추게 되죠.",
            },
            {
    ...
    introSections: [
        ...
        },
        {
            ...
            title: "6차시, 비교에서 제작·검증·발표까지",
            description:
                "교육 전: 'AI는 만능 도구, 답변은 100% 사실' → 교육 후: AI를 내 의도와 목적에 맞게 설계하는 능동적 도구로 인식. 내가 필요한 AI를 구조적으로 기획하고 직접 구축하며, AI도 오류가 가능함을 알고 비판적으로 검증하는 시야를 장착합니다.",
            imageSrc: "",
        },
        {
            subtitle: "PORTFOLIO",
