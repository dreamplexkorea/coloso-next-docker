...
const courseDetail: CourseDetail = {
  ...
  title: "천문학자 체험: 우주를 탐험하는 과학자의 하루",
  subtitle: "망원경 관측부터 별자리 분석까지, 우주과학의 경이로움을 체험하는 프로그램",
  heroImageSrc: "/images/products/space-scientist/hero.png",
  heroEyebrow: "DREAMPLEX · 과학/기술 진로직업체험",
  heroHeadline: "밤하늘의 별은 수억 년 전의 편지입니다",
  heroSubcopy: "천문학 박사급 연구원이 학교로 찾아가, 우주의 신비를 과학으로 풀어드립니다.",
  heroChips: ["중등 대상","천체 관측","우주 과학"],
  heroProofStats: [
    { label: "운영 학교", value: "116+" },
    { label: "참여 학생", value: "2,658+" },
    { label: "평균 만족도", value: "4.7 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "과학/기술", "중등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX ASTRONOMER",
    role: "천문학 연구원 & 우주과학 교육 전문가",
    avatarSrc: "",
    bio: "천문학 연구원 & 우주과학 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
