...
const courseDetail: CourseDetail = {
  slug: "robot-engineer",
  title: "로봇공학자 체험: 로봇을 만들고 움직여라",
  subtitle: "기구학과 프로그래밍의 기초를 체험하며 로봇 산업의 미래를 탐색하는 프로그램",
  heroImageSrc: "/images/products/robot-engineer/hero.png",
  heroEyebrow: "DREAMPLEX · 과학/기술 진로직업체험",
  heroHeadline: "기계에 생명을 불어넣는 공학자가 되어라",
  heroSubcopy: "로봇공학 전문가가 학교로 찾아가, 로봇 조립과 기초 프로그래밍을 가르칩니다.",
  heroChips: ["중등 대상","로봇 조립","프로그래밍"],
  heroProofStats: [
    { label: "운영 학교", value: "32+" },
    { label: "참여 학생", value: "2,679+" },
  ...
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX ROBOTICS",
    role: "로봇공학 박사 & STEM 교육 전문가",
    avatarSrc: "",
    bio: "로봇공학 박사 & STEM 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
