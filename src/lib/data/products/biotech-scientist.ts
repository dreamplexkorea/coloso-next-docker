...
const courseDetail: CourseDetail = {
  ...
  title: "생명공학자 체험: DNA를 다루는 과학자의 세계",
  subtitle: "DNA 추출 실험부터 유전공학 기초까지, 바이오 산업의 최전선을 체험하는 프로그램",
  heroImageSrc: "/images/products/biotech-scientist/hero.png",
  heroEyebrow: "DREAMPLEX · 과학/기술 진로직업체험",
  heroHeadline: "0.000001mm의 나선 속에 생명의 비밀이 있다",
  heroSubcopy: "생명공학 연구원이 학교로 찾아가, DNA와 유전자의 세계를 실험으로 보여줍니다.",
  heroChips: ["중등 대상","DNA 추출","생명과학"],
  heroProofStats: [
    { label: "운영 학교", value: "89+" },
    { label: "참여 학생", value: "2,395+" },
  ...
  instructor: {
    name: "DREAMPLEX BIO",
    role: "생명공학 박사 & 바이오 교육 전문가",
    avatarSrc: "",
    bio: "생명공학 박사 & 바이오 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
