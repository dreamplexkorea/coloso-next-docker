...
const courseDetail: CourseDetail = {
    ...
    reviews: [
        ...
        },
        {
            id: "rev-3",
            rating: 5,
            title: "선생님도 학생도 모두 만족한 수업",
            content: "진로체험 수업 중 가장 반응이 좋았어요. 학생들이 직접 음료를 만들고 과학 원리까지 배우니 교육적으로도 완벽했습니다.",
            authorName: "이*진 선생님",
            authorGrade: "서울 ○○초등학교 담임교사",
            characterId: 3,
        },
        {
            id: "rev-4",
            rating: 4,
            title: "아이들이 집에서도 따라 해봤어요",
            content: "수업 후 레시피 카드를 받아왔는데, 주말에 온 가족이 같이 만들어봤어요. 체험이 수업으로 끝나지 않고 이어진다는 게 좋았습니다.",
            authorName: "박*수 학부모",
            authorGrade: "초등학교 6학년 학부모",
            characterId: 4,
        },
        {
            id: "rev-5",
            rating: 5,
            title: "바리스타라는 직업을 새롭게 봤어요",
            content: "그냥 커피 타는 사람인 줄 알았는데, 화학이랑 물리학을 다 알아야 한다는 게 신기했어요. 식품공학자도 되고 싶어졌어요!",
            authorName: "최*아 학생",
            authorGrade: "초등학교 5학년",
            characterId: 5,
        },
        {
            id: "rev-6",
            rating: 4,
            title: "체험 시간이 조금 더 길었으면 좋겠어요",
            content: "90분이 너무 빠르게 지나갔어요. 라떼아트를 더 연습하고 싶었는데 시간이 부족했습니다. 그래도 정말 재미있었어요!",
            authorName: "강*민 학생",
            authorGrade: "초등학교 4학년",
            characterId: 0,
        },
