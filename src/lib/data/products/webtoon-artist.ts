...
const courseDetail: CourseDetail = {
  slug: "webtoon-artist",
  title: "웹툰 작가 체험: 디지털 만화의 기획과 창작",
  subtitle: "스토리 구성부터 디지털 드로잉까지, 웹툰 산업의 전 과정을 체험하는 프로그램",
  heroImageSrc: "/images/products/webtoon-artist/hero.png",
  heroEyebrow: "DREAMPLEX · 예술/디자인 진로직업체험",
  heroHeadline: "당신의 이야기가 수백만 독자의 공감이 된다",
  heroSubcopy: "현직 연재 웹툰 작가가 학교로 찾아가, 디지털 만화 창작의 비밀을 전수합니다.",
  heroChips: ["초등 대상","디지털 드로잉","스토리텔링"],
  heroProofStats: [
    { label: "운영 학교", value: "119+" },
    { label: "참여 학생", value: "4,209+" },
    { label: "평균 만족도", value: "4.7 / 5.0" },
  ],
  heroTheme: "cinematic-dark",
  tags: ["진로직업체험", "예술/디자인", "초등"],
  status: "학교 출강 운영중",
  instructor: {
    name: "DREAMPLEX ARTIST",
    role: "현직 웹툰 작가 & 디지털 아트 교육 전문가",
    avatarSrc: "",
    bio: "현직 웹툰 작가 & 디지털 아트 교육 전문가이(가) 학생 눈높이에 맞춘 전문 교육을 설계하고 진행합니다.",
    career: [
